...
@interface WizardSkillDetailViewController : HeroSkillDetailViewController <UIScrollViewDelegate ,UITableViewDelegate ,UITableViewDataSource>
{
...
@property (retain, nonatomic) IBOutlet UIView *force;
@property (retain, nonatomic) IBOutlet UIView *conjuration;
@property (retain, nonatomic) IBOutlet UIView *mastery;
#pragma sub views
