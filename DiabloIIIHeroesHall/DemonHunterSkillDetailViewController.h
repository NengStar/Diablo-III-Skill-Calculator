...
@interface DemonHunterSkillDetailViewController : HeroSkillDetailViewController <UIScrollViewDelegate ,UITableViewDelegate ,UITableViewDataSource>
{
...
@property (retain, nonatomic) IBOutlet UIView *hunting;
@property (retain, nonatomic) IBOutlet UIView *devices;
@property (retain, nonatomic) IBOutlet UIView *archery;
#pragma sub views
