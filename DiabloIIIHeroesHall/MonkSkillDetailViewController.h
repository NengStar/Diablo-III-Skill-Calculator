...
@interface MonkSkillDetailViewController : HeroSkillDetailViewController <UIScrollViewDelegate ,UITableViewDelegate ,UITableViewDataSource>
{
...
@property (retain, nonatomic) IBOutlet UIView *techniques;
@property (retain, nonatomic) IBOutlet UIView *focus;
@property (retain, nonatomic) IBOutlet UIView *mantras;
#pragma sub views
